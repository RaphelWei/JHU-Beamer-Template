...
\addtobeamertemplate{frametitle}{}{
    \begin{textblock*}{100mm}(.8\textwidth,-1.07cm)
        \includegraphics[height=1.2cm]{./Figures/logo/logo.png}
    \end{textblock*}}

\definecolor{themecolor}{RGB}{0, 45, 114}
\mode<presentation>
{
...
\titlegraphic{\includegraphics[height=2cm]{./Figures/logo/logo2.jpg}}
